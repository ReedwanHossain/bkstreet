    ...
    var loc;
    var PSV;
    var baseUrl = 'http://192.168.31.190:8085/'
    // var baseUrl = 'http://map.barikoi.xyz/'
    ...
    }).setView([23.77116211, 90.35702678], 15);
    ...
    loc = L.marker([23.77116211, 90.35702678], {
        icon: greenIcon
    }).addTo(map)
    ...
    // map.addControl(new L.map.Control.Fullscreen());
    ...
    var onPolyClick = function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                map.setView([panos[0].latitude, panos[0].longitude], map.getZoom());
